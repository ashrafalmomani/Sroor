...
class AccountPartnerLedger(models.TransientModel):
    ...
    def generate_partner_ledger(self, data):
        ...
        data['form'] = self.read(
            ['date_from', 'date_to', 'journal_ids', 'display_account', 'target_move', 'reconciled', 'result_selection',
             'amount_currency'])[0]
    ...
    def print_xls(self):
        report_obj = self.env['report.aspl_accounting_report.partner_ledger_template'].with_context(
