...
class trial_balance_wiz(models.TransientModel):
    ...
    def print_pdf(self, data):
        ...
        return self.env.ref('aspl_accounting_report.report_trial_balance').report_action(self, data=datas)
    ...
    def print_xls(self):
        ...
        report_obj = self.env['report.aspl_accounting_report.trial_balance_template']
        styleP = xlwt.XFStyle()
